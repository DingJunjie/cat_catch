...
function circleClicked(event) {
    ...
    switch(dir) {
        case MOVE_LEFT:
            ...
            console.log('MOVE_LEFT '+currentCat);
            break;
        case MOVE_UP_LEFT:
            currentCat.setCircleType(Circle.TYPE_UNSELECTED);
            currentCat = circleArr[currentCat.indexY%2?currentCat.indexX:currentCat.indexX - 1][currentCat.indexY-1];
            currentCat.setCircleType(Circle.TYPE_CAT);
            console.log('MOVE_UP_LEFT '+currentCat);
            break;
        case MOVE_UP_RIGHT:
            currentCat.setCircleType(Circle.TYPE_UNSELECTED);
            currentCat = circleArr[currentCat.indexY%2?currentCat.indexX+1:currentCat.indexX][currentCat.indexY-1];
            currentCat.setCircleType(Circle.TYPE_CAT);
            console.log('MOVE_UP_RIGHT '+currentCat);
            break;
        case MOVE_RIGHT:
            currentCat.setCircleType(Circle.TYPE_UNSELECTED);
            currentCat = circleArr[currentCat.indexX + 1][currentCat.indexY];
            currentCat.setCircleType(Circle.TYPE_CAT);
            console.log('MOVE_RIGHT '+currentCat);
            break;
        case MOVE_DOWN_RIGHT:
            currentCat.setCircleType(Circle.TYPE_UNSELECTED);
            currentCat = circleArr[currentCat.indexY%2?currentCat.indexX+1:currentCat.indexX][currentCat.indexY+1];
            currentCat.setCircleType(Circle.TYPE_CAT);
            console.log('MOVE_DOWN_RIGHT '+currentCat);
            break;
        case MOVE_DOWN_LEFT:
            currentCat.setCircleType(Circle.TYPE_UNSELECTED);
            currentCat = circleArr[currentCat.indexY%2?currentCat.indexX:currentCat.indexX-1][currentCat.indexY+1];
            currentCat.setCircleType(Circle.TYPE_CAT);
            console.log('MOVE_DOWN_LEFT '+currentCat);
            break;
        default:
            alert("game over");
...
//    }
    ...
    if(currentCat.indexX == 0 || currentCat.indexX == 8 || currentCat.indexX == 0 || currentCat.indexY == 8) {
        alert('游戏结束');
    }
